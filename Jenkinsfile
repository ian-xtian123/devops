    ...
    stage('Build, Test and Code Quality') {
      steps {
        withSonarQubeEnv(installationName: 'SonarQube', credentialsId: 'SonarQube') {
          ...
          bat '"C:\\Program Files (x86)\\Microsoft Visual Studio\\2019\\Professional\\Common7\\IDE\\MSTest.exe" /testcontainer:\'Case Study.Tests\\bin\\Debug\\Case Study.Tests.dll\' /resultsfile:MSTestResults.trx'
