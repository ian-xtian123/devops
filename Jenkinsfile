    ...
    stage('Build, Test and Code Quality') {
      steps {
        withSonarQubeEnv(installationName: 'SonarQube', credentialsId: 'SonarQube') {
          ...
          bat '"C:\\Program Files (x86)\\Microsoft Visual Studio\\2019\\Professional\\Common7\\IDE\\Extensions\\TestPlatform\\vstest.console.exe" /Logger:"TestResults\\*.trx" "CaseStudy.Tests\\bin\\Release\\CaseStudy.Tests.dll"'
